...
public class Site {
     ...
     * @author Enner Escobedo C. <email>eriec.42@gmail.com</email>
     * <date>02/07/2013</date>
     * @param iSiteId the iSiteId to set
     */
     ...
     * @author Enner Escobedo C. <email>eriec.42@gmail.com</email>
     * <date>02/07/2013</date>
     * @param sNameSite the sNameSite to set
     */
     ...
     * @author Enner Escobedo C. <email>eriec.42@gmail.com</email>
     * <date>02/07/2013</date>
     * @param sCodeSite the sCodeSite to set
     */
     ...
     */
    public boolean Exists (Integer siteId){
    ...
    /**
     * Sets the properties values of Site
     * @author Enner Escobedo C. <email>eriec.42@gmail.com</email>
     * <date>02/07/2013</date>
     * @param iSiteId, site identifier
     * @param sNameSite, name of site
     * @param sCodeSite, code of site
     */
    public Site(Integer iSiteId, String sNameSite, String sCodeSite) {
