...
public class QuestionnaireSet {
    ...
    public ArrayList<QuestionnaireSet> getAll (){
        ...
        ArrayList<Object> alListRecords;
     ...
     * @author Enner Escobedo C. <email>enner.castillo@centrikal.com</email>
     * <date>Jul 9, 2013</date>
     * @return a List (of QuestionnaireSet) with all the Questionnaire Sets of the Study
     * that fulfills their Precondition.
     */
