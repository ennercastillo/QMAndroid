...
public class ObjectStoreManager {
    ...
    public ObjectStoreManager(Context ctx, String name) {
        context = ctx;
        dbName = Constants.DB.DBNAMED + name;
        conn = new ObjectStoreHelper(ctx, dbName);
    }
    ...
    public StoreObject retrive(String guid, String property) {
        ...
        if (conn == null) {
            conn = new ObjectStoreHelper(context, dbName);
        }
    ...
    public void store(String guid, String property, String value) {
        SQLiteDatabase db;
        String insertString = "INSERT INTO " + TBL_STORE + " (" + FLD_ID + "," + FLD_PROPERTY + ","
                + FLD_VALUE + "," +
                FLD_DATE + "," + FLD_USER + "," + FLD_DEVICE + ") VALUES ('" + guid + "','"
                + property +
                "','" + value + "','" + ObjectStoreUtility.getDate() + "','"
                + ObjectStoreUtility.getUser(context) +
